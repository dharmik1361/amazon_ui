            ...
            child: Container(
              ...
              child: Row(
                children: [
                  ...
                  SizedBox(width: 8.0),
                  Text("Deliver to Dharmik - Rajkot 360024",
...
class __PrimeToggleBarState extends State<_PrimeToggleBar> {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Row(
        children: [
          Image.asset("image/prime.png", height: 25.0),
          Switch(
              value: _primeEnabled,
              ...
              child: SingleChildScrollView(
                child: Column(
                  children: [
                    ...
                    _Item(
                      image: "image/dot.webp",
                      title:
                      "Echo Dot (4th generation) | Smart speaker with Alexa | Blue",
                      price: "3,945₹",
                    ),
                    const SizedBox(height: 8.0),
                    _Item(
                      image: "image/echo.webp",
                      title:
